        ...
        {error && cpf && !invalidCpf ? (
          <>
            ...
            >
              <Image
                src={AppStore}
                alt="Imagem com link para Google App Store"
              />
            </a>
          </>
          ...
          <>
            <p className="toggle-hide-qr">
              E-mail inválido! Não possui uma conta? Faça a leitura do nosso QR
              Code e cadastre-se!
            </p>
            <p className="toggle-hide-app">
              E-mail inválido! Não possui uma conta? Baixe nosso aplicativo na
              App Store!
            </p>
            <Image
              className="toggle-hide-qr"
